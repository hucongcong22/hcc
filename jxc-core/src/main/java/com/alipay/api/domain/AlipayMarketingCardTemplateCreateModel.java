...
public class AlipayMarketingCardTemplateCreateModel extends AlipayObject {
    ...
    private static final long serialVersionUID = 6413176754684755682L;
     ...
     * 卡级别配置
     */
    @ApiField("card_level_conf")
    private TemplateCardLevelConfDTO cardLevelConf;
    ...
    public TemplateCardLevelConfDTO getCardLevelConf() {
        return this.cardLevelConf;
    }

    public void setCardLevelConf(TemplateCardLevelConfDTO cardLevelConf) {
