...
var client = new Vue({
    ...
    methods: {
        write: function () {
            var data = ajax("../api/clientWrite", "post", {
                "name": "李总",
                "vip": "铂金vip",
                "tel": "1525139256",
...
var goods = new Vue({
    ...
    methods: {
        ...
        select: function () {
            var data = get("../api/goods/like", "get", {
                "start": 0,
                "end": 5,
                "createTimeStart": "2018-02-21",
                "createTimeEnd": "2018-02-22"
            }, false)
            console.log(data)
        },
        updata: function () {
            var data = ajax("../api/goods", "patch", {
                "id": 2,
                "name": "坚果pro2",
                "trademark": "锤子科技",
                "retailPrice": "2299",
