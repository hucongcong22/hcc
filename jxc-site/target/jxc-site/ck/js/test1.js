...
var money =new Vue({
    ...
    methods:{
        writePurchase:function(){
            var data=ajax("../api//purchaseDetail/payment/"+272,"patch",{"paid":"200","purchaseId":"26","goodsId":3},false)
            console.log(data)
        },
        writeSales:function(){
            var data=ajax("../api/salesDetail/receipt/"+430,"patch",{"paid":"200","salesId":"107","goodsId":3},false)
            console.log(data)
        },
        oughtReceipt:function () {
            var data=get("../api/sales/oughtReceipt","get",{"createTimeStart":"2018-02-23","createTimeEnd":"2018-02-25"},false)
            console.log(data)
        },
        oughtPayment:function () {
            var data=get("../api/purchase/oughtPayment","get",{"createTimeStart":"2018-02-23","createTimeEnd":"2018-02-25","endTimeStart":"2018-02-23","endTimeEnd":"2018-02-25"},false)
            console.log(data)
        },
...
var units =new Vue({
    ...
    methods:{
        write:function(){
            var data=ajax("../api/units","post",{"type":2,"name":"个","unitsBo":[{"name":"箱","weight":"10"},{"name":"盒","weight":"2"}]},false)
            console.log(data)
        },
        select:function(){
...
var  purchase =new Vue({
    ...
    methods:{
        ...
        shenhe:function (){
            var data=ajax("../api/purchase/audit","post",{'purchaseBo':[
...
var  otherStoreIn =new Vue({
    ...
    methods:{
        write:function(){
            var data = ajax("../api/otherStoreIn","post",{ "goods":[ {"id":2,"num":10},{"id":3,"num":8}],"info":"", "warehouseId":"3"},false)
            console.log(data)
        },updata:function(){
            var data = ajax("../api/otherStoreIn/"+10,"patch",{ "goods":[ {"id":2,"num":3},{"id":3,"num":2}],"info":"", "warehouseId":"3","state":1},false)
            console.log(data)
        },
        tiojiao:function () {
            var data = ajax("../api/otherStoreIn/"+10,"patch",{ "goods":[ {"id":2,"num":3},{"id":3,"num":2}],"info":"", "warehouseId":"3","state":2},false)
            console.log(data)
        },
        shenhe:function () {
